...
layout = html.Div(
	children = [
	dcc.Link(html.H1('BOSS CLUB'), href = "/", style = {'display': 'inline-block', 'margin-left': '4%', 'margin-right':'4%'}),
	...
	html.A([
            html.Img(
				...
				style={
                    ...
                    'width' : '2%',
					'margin-left' : '1%'}),
    ], href="https://twitter.com/ClubWLBOSS", target="_blank"),
	html.A([
            html.Img(
    ...
    html.Div(children =[
        ...
        ], style = {'display':'inline-block','margin-top':'37%', 'margin-left': '4%', "border":"2px black solid", 'width':'30%', 'padding-left':'3%'}
    ),
    html.Div(children = [
